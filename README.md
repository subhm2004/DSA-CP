...
**Starting from zero?** → [Patterns](./DSA/patterns/) (nested loops) · **[Thita Patterns Sheet](https://docs.google.com/spreadsheets/u/0/d/1EEYzyD_483B-7CmWxsJB_zycdv4Y5dxnzcoEQtaIfuk/htmlview)** (practice list) → [Basics](./DSA/basics/) → phir arrays / recursion.
